...
const booking = require("./Routes/transactions");
// const membership = require("./Routes/transactions");
// const wallets = require("./Routes/transactions");
// const withdraw = require("./Routes/transactions");
const app = express();
const PORT = 1337;
app.use(cors());
